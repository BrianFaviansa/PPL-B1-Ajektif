...
@section('content')
    <h2 class="text-4xl font-semibold dark:text-white mb-8">Ubah Pengajuan Bantuan Alsintan</h2>

    <form class="grid gap-6" action="{{ route('pengajuan.update', $pengajuan->id) }}" method="POST"
        ...
        <div>
            <label for="nama_alsintan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                Alsintan</label>
            <input type="text" id="nama_alsintan" name="nama_alsintan" value="{{ $pengajuan->nama_alsintan }}"
        ...
        <div>
            ...
            <textarea id="alasan_pengajuan" name="alasan_pengajuan" rows="4"
                ...
                placeholder="Tuliskan alasan pengajuan">{{ $pengajuan->alasan_pengajuan }}</textarea>
        ...
        <div>
            ...
            <input
                ...
                aria-describedby="dokumen_pengajuan_help" id="dokumen_pengajuan" name="dokumen_pengajuan" type="file">
