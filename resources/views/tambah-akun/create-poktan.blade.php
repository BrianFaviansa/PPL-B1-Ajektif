...
@section('content')
    <h2 class="text-4xl font-semibold dark:text-white mb-8">Tambah Akun Poktan</h2>


    <form action="{{ route('akun.storePoktan') }}" method="POST">
        @csrf
        <div class="my-4">
        ...
        <button type="submit"
            class="max-w-xs focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Simpan</button>
    </form>
@endsection
