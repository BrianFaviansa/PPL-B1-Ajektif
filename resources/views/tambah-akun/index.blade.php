        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <div class="grid md:grid-cols-2 gap-8">
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Tambah Akun Poktan
                    </h2>
                ...
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Tambah Akun BPP</h2>
